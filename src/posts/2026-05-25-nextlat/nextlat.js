...
export const benchmarkSlides = [
  ...
  },
  {
    ...
    description: "The A5 word problem is a difficult state-tracking task inexpressible by transformers (see Merrill et al., 2024). Surprisingly, under NextLat training, the co-trained RNN (the latent dynamics models) can generalize far beyond the expressivity limits of the underlying transformer and solve the task, despite being trained entirely in parallel. We recommend reading Section 5.2 of the paper for a detailed explanation of this phenomenon.",
